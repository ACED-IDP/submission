...
from aced_submission.simplifier import simplify, _render_dialect, SimplifierContextManager


def test_simplify_medication():
    ...
    with SimplifierContextManager():
        ...
        rendered = _render_dialect(simplified, references, 'GEN3')
        ...
        assert condition, "Should render CodeableReference relation"
